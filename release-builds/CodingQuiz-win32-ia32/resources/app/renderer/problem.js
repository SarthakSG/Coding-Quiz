...
if (problems.length > 0) {
    ...
    document.querySelector('#p-statement').innerHTML = problems[pNum].statement;
    document.querySelector('#p-input').innerHTML = problems[pNum].inputPattern;
    document.querySelector('#p-output').innerHTML = problems[pNum].outputPattern;
    document.querySelector('#p-constraints').innerHTML = problems[pNum].constraints;
    document.querySelector('#name').innerHTML = problems[pNum].name;
    document.querySelector('#p-sample-input').innerHTML = problems[pNum].exampleInput;
    document.querySelector('#p-sample-output').innerHTML = problems[pNum].exampleOutput;
    document.querySelector('#p-explaination').innerHTML = problems[pNum].exampleExplaination;
...
document.querySelector('#get-input').addEventListener('click', () => {
    ...
    electron.shell.openItem(path.join(appRootPath, `data/inputs/${pNum}.txt`));
...
document.querySelector('#submit-output').addEventListener('click', () => {
    ...
    if (document.querySelector('#inputGroupFile02').value != null) {
        const outputPath = `data/o/${pNum}.txt`;
